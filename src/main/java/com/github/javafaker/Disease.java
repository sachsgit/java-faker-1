...
public class Disease {
     ...
     * 
     * @param faker
     *            The Faker instance for generating random, different kinds of disease, e.g. the
     *            internal disease.
     */
    ...
    public String ophthalmologyAndOtorhinolaryngology() {
        return faker.fakeValuesService().resolve("disease.ophthalmology_and_otorhinolaryngology",
            this, faker);
    }

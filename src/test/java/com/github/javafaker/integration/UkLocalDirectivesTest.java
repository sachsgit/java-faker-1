...
public class UkLocalDirectivesTest {
    ...
    /**
     * uk is interesting in that it has feminine and masculine prefixes for street names. the
     * feminine
     * and masculine prefixes are NOT methods on Address though as they only make sense for this
     * locale (and possibly
     * others). This test shows we can resolve within the yml file without reaching out to any of
     * the {@link Faker}
     * child objects.
     */
    @Test
    public void resolvesDirectivesOnlyInYmlFile() {
        ...
        assertThat("the streetname starts with a fem or masc prefix",
            startsWithFemPrefix || startsWithMascPrefix, is(true));
    }
